...
The 200 MHz clock rate of the fractal generator is less than two times the VGA pixel rate. Any "sub-optimal" handshaking scheme that requires an idle clock cycle to recover would break the architecture.
